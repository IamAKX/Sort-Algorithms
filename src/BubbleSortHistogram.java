...
public class BubbleSortHistogram extends Application {
...
//        chart.setAnimated(false);
        ...
        series.setName("Bubble Sorting Histogram");
...
//        root.setBottom(buttons);
        ...
        return new Task<Void>() {
            ...
            protected Void call() throws Exception {
                ...
                for (int i = 0; i < data.size() - 1; i++) {
                    ...
                    int finalI = i;
                    Platform.runLater(() -> {
                        series.getData().get(data.size() - finalI - 1).getNode().setStyle("-fx-background-color: blue ;");
    ...
    private <T> Animation createSwapAnimation(Data<?, T> first, Data<?, T> second) {
        ...
        TranslateTransition firstTranslate = new TranslateTransition(Duration.millis(200), first.getNode());
        firstTranslate.setByX(secondX - firstX);
        TranslateTransition secondTranslate = new TranslateTransition(Duration.millis(200), second.getNode());
